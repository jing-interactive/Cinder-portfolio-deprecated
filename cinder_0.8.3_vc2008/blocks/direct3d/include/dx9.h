...
/** \brief Enables alpha testing and sets the \c AlphaFunc to test for values which are \a func than \a value, which should be in the range [0, 255]. 
 *  Possible values for \a func include <tt> D3DCMP_NEVER, D3DCMP_LESS, D3DCMP_EQUAL, D3DCMP_LESSEQUAL, D3DCMP_GREATER, D3DCMP_NOTEQUAL, D3DCMP_GREATEREQUAL and D3DCMP_ALWAYS</tt>. **/
void enableAlphaTest( DWORD value = 120, D3DCMPFUNC func = D3DCMP_GREATER );
