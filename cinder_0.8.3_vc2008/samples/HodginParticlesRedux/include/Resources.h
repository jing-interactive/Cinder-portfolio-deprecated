...
#define RES_EMITTER_VERT	CINDER_RESOURCE( ../resources/, emitter_vert.glsl, 128, GLSL )
#define RES_EMITTER_FRAG	CINDER_RESOURCE( ../resources/, emitter_frag.glsl, 129, GLSL )
