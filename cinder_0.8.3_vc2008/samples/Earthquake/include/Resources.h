...
#define RES_EARTHMASK		CINDER_RESOURCE( ../resources/, earthMask.png, 130, PNG )
#define RES_EARTHNORMAL		CINDER_RESOURCE( ../resources/, earthNormal.png, 131, PNG )
#define RES_PASSTHRU_VERT	CINDER_RESOURCE( ../resources/, passThru_vert.glsl, 132, GLSL )
