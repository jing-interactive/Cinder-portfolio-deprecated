...
Values of x can range from approximately 每2.2 to 2.2.
Values of y can range from approximately 每1.6 to 1.6.
	...
	void Nui_GotDepthAlert( )
	{
		...
		if( LockedRect.Pitch != 0 )
		{
			...
			{ 
				...
				//The high-order bits (bits 3每15) contain the depth value in millimeters. 
