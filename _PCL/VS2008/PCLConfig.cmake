...
macro(find_boost)
  ...
  elseif(NOT BOOST_INCLUDEDIR)
    set(BOOST_INCLUDEDIR "f:/boost_1_47_0")
...
macro(find_eigen)
  ...
  elseif(NOT EIGEN_ROOT)
    get_filename_component(EIGEN_ROOT "f:/__svn_pool/CreativeCoding/_common/Eigen" PATH)
  endif(PCL_ALL_IN_ONE_INSTALLER)
  if(PkgConfig_FOUND)
  ...
  set(EIGEN_DEFINITIONS ${EIGEN_DEFINITIONS} -DEIGEN_USE_NEW_STDVECTOR -DEIGEN_YES_I_KNOW_SPARSE_MODULE_IS_NOT_STABLE_YET)
endmacro(find_eigen)
...
macro(find_openni)
  if(NOT OPENNI_ROOT AND ("" STREQUAL "ON"))
    set(OPENNI_INCLUDE_DIRS_HINT "OPENNI_INCLUDE_DIR-NOTFOUND")
    set(OPENNI_LIBRARY_HINT "OPENNI_LIBRARY-NOTFOUND")
...
macro(find_flann)
  ...
  elseif(NOT FLANN_ROOT)
    get_filename_component(FLANN_ROOT "f:/__svn_pool/CreativeCoding/_common/flann" PATH)
  endif(PCL_ALL_IN_ONE_INSTALLER)
  if(PkgConfig_FOUND)
...
elseif(EXISTS "${PCL_DIR}/include/pcl/pcl_config.h")
  ...
  set(PCL_SOURCES_TREE "f:/__svn_pool/CreativeCoding/_PCL")
...
set(pcl_all_components  common kdtree octree search range_image features sample_consensus filters io keypoints registration segmentation surface )
...
foreach(component ${PCL_TO_FIND_COMPONENTS})
  ...
  find_library(PCL_${COMPONENT}_LIBRARY ${pcl_component}
    HINTS ${PCL_LIBRARY_DIRS} "${PCL_DIR}/${component}"
  ...
  if(NOT PCL_${COMPONENT}_LIBRARY_DEBUG AND PCL_${COMPONENT}_LIBRARY)
    set(PCL_${COMPONENT}_LIBRARY_DEBUG ${PCL_${COMPONENT}_LIBRARY})
  endif(NOT PCL_${COMPONENT}_LIBRARY_DEBUG AND PCL_${COMPONENT}_LIBRARY)
...
if(PCL_FOUND)
  set(PCL_VERSION ${PCL_FOUND_VERSION} CACHE STRING "PCL version")
endif(PCL_FOUND)
